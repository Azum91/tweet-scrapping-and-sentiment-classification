...
def create_webdriver_instance():
    ...
    driver = webdriver.Firefox(executable_path="./geckodriver-v0.33.0-win32/geckodriver.exe",options=options)

    return driver

def login_to_twitter(driver, username,phone, password):
    sleep(2)
    ...
    sleep(2)
    phone_field = driver.find_element(By.XPATH, '/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[2]/label/div/div[2]/div/input')
    phone_field.send_keys(phone)

    next_button = driver.find_element(By.XPATH, '/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div/div/div')
    next_button.click()
    sleep(2)
...
def main(search_term, filepath, page_sort='Latest'):
    ...
    driver = login_to_twitter(driver,username,phone,Password)
...
if __name__ == '__main__':
    path = './data/path_for_raw_data.csv'
    term = 'Topic of interest'
